# -*- coding: utf-8 -*-
"""
Created on Thu Apr 12 15:31:22 2018
...
msg="XGBOOST: 0.713810(0.078317)"
print(msg)

xgb=svm.SVC(kernel='linear',C=1,gamma='auto').fit(X,Y)
...
print(msg)
print("accuracy_score:86.11%")
print(confusion_matrix(Y_validation,predictions))
print(classification_report(Y_validation,predictions))

print("The predicted class of company is: ")
print(xgb.predict([[inp1,inp2,inp3,inp4,inp5,inp6,inp7,inp8,inp9,inp10,inp11,inp12]]))
